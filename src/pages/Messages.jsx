...
function ChatThreadScreen({ partnerId, partnerName, isVendorKnown, onOpenVendor, thread = [], onSend, onBack }) {
  ...
  return (
    <div className="flex flex-col h-[70vh] bg-white rounded-xl shadow p-4">
      <div className="flex items-center mb-4">
        ...
        <h3 className="font-semibold ml-2 flex-1">{partnerName}</h3>
        {isVendorKnown && typeof onOpenVendor === "function" && (
          <Button variant="ghost" size="sm" onClick={() => onOpenVendor(partnerId)} className="inline-flex items-center gap-1">
